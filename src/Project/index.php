      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-14 items-center">
        ...
        <div class="w-full">
          <div class="w-full h-80 sm:h-[28rem] md:h-[30rem] lg:h-[34rem] rounded-xl overflow-hidden shadow-lg">
            <iframe class="w-full h-full rounded-lg" src="https://www.youtube.com/embed/ZUvRfje0k_I?autoplay=1&mute=1
" title="YouTube video" frameborder="0"
    ...
    <section class="py-16 px-4 sm:px-6 lg:px-8 bg-green-50" id="contact">
      <div class="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <!-- Right: Contact Form -->
        <form action="https://getform.io/f/aroorgnb" method="POST" class="bg-white shadow-xl rounded-2xl p-8 space-y-6">
